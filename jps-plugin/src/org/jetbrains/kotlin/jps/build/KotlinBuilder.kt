...
import org.jetbrains.kotlin.jps.model.KotlinMppModuleKind
import org.jetbrains.kotlin.jps.model.mppModelKind
...
class KotlinBuilder : ModuleLevelBuilder(BuilderCategory.SOURCE_PROCESSOR) {
    ...
    override fun build(
        ...
        if (chunk.modules.any { it.mppModelKind == KotlinMppModuleKind.NEW_MODEL_SOURCE_SET_HOLDER }) {
