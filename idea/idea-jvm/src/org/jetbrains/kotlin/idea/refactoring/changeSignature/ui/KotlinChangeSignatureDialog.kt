...
class KotlinChangeSignatureDialog(
        ...
        org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel>(project, methodDescriptor, false, context) {
    ...
    private val parametersTableModel: org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel get() = super.myParametersTableModel
        ...
        return object : JBTableRowEditor() {
            ...
            override fun prepareEditor(table: JTable, row: Int) {
                ...
                for (columnInfo in parametersTableModel.columnInfos) {
                    ...
                    if (org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel.isTypeColumn(columnInfo)) {
                    ...
                    else if (org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel.isNameColumn(columnInfo)) {
                        editor = nameEditor
                        component = editor
                        updateNameEditor()
                    }
                    else if (org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel.isDefaultValueColumn(columnInfo) && isDefaultColumnEnabled()) {
                        val document = PsiDocumentManager.getInstance(project).getDocument(item.defaultValueCodeFragment)
                        editor = EditorTextField(document, project, fileType)
                        component = editor
                    }
                    else if (org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinPrimaryConstructorParameterTableModel.isValVarColumn(columnInfo)) {
                    ...
                    else if (org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinFunctionParameterTableModel.isReceiverColumn(columnInfo)) {
                        ...
                        checkBox.addItemListener {
                            ...
                            (parametersTableModel as org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinFunctionParameterTableModel).receiver = newReceiver
                            updateSignature()
                            updateNameEditor()
                        }
                        component = checkBox
            ...
            override fun getValue(): JBTableRow {
                return JBTableRow { column ->
                    ...
                    when {
                        org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinPrimaryConstructorParameterTableModel.isValVarColumn(columnInfo) ->
                            (components[column] as @Suppress("NO_TYPE_ARGUMENTS_ON_RHS") JComboBox).selectedItem
                        org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel.isTypeColumn(columnInfo) ->
                            item.typeCodeFragment
                        org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel.isNameColumn(columnInfo) ->
                            (components[column] as EditorTextField).text
                        org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel.isDefaultValueColumn(columnInfo) ->
    ...
    companion object {
        private fun createParametersInfoModel(descriptor: KotlinMethodDescriptor, defaultValueContext: PsiElement): org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel {
            val typeContext = getTypeCodeFragmentContext(defaultValueContext)
            return when (descriptor.kind) {
                KotlinMethodDescriptor.Kind.FUNCTION -> org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinFunctionParameterTableModel(descriptor, typeContext, defaultValueContext)
                KotlinMethodDescriptor.Kind.PRIMARY_CONSTRUCTOR -> org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinPrimaryConstructorParameterTableModel(descriptor, typeContext, defaultValueContext)
                KotlinMethodDescriptor.Kind.SECONDARY_CONSTRUCTOR -> org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinSecondaryConstructorParameterTableModel(descriptor, typeContext, defaultValueContext)
            }
        }
        ...
        private fun evaluateChangeInfo(parametersModel: org.jetbrains.kotlin.idea.refactoring.changeSignature.ui.KotlinCallableParameterTableModel,
