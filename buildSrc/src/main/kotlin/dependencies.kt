...
fun DependencyHandler.protobufLite(configurationName: String = "compile") =
         ":protobuf-2.6.1-lite"
val protobufLiteTask = "$protobufLiteProject:prepare"

fun DependencyHandler.protobufFull(configurationName: String = "compile") =
         ":protobuf-java-relocated-2.6.1"
