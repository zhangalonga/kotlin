...
class PsiBasedSourcesManager(
    ...
    */
    ...
    override fun spanForReturnTypeIfAny(irDeclaration: IrDeclaration, currentFile: IrFile): Span? {
        val kind = irDeclaration.declarationKind
        if (kind == IrDeclarationKind.CONSTRUCTOR || irDeclaration.descriptor is PropertyAccessorDescriptor) return null
