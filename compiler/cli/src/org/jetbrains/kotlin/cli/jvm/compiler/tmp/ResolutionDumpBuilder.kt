...
class IrBasedResolutionDumpBuilder(private val bindingContext: BindingContext, private val nativeElementsFactory: NativeElementsFactory, private val root: File) {
    ...
    inner class Ir2ResolutionDumpConverter : IrElementVisitorVoid {
        ...
        override fun visitCall(expression: IrCall) {
            ...
            for (typeParameter in descriptor.typeParameters) {
                val kotlinTypeArgument = expression.getTypeArgument(typeParameter)
