...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(ANNOTATION_TARGETS_NON_EXISTENT_ACCESSOR, "An accessor will not be generated for ''{0}'' so the annotation will not be available via reflection", STRING);
