...
enum class LanguageFeature(
     ...
     * If 'true', then enabling this feature using '-XXLanguage:' will force generation of pre-release
     * binaries (given that [sinceVersion] > [LanguageVersion.LATEST_STABLE]).
